export const frontendSkillArray = [
  {
    name: 'HTML',
    icon: './images/skill/html-logo.png',
    level: 90,
    text: '시맨틱 마크업과 브라우저 렌더링 프로세스에 대해서 잘 알고 있습니다.',
  },
  {
    name: 'CSS',
    icon: './images/skill/css-logo.png',
    level: 90,
    text: '크로스 브라우징을 위한 스타일링 방법을 알고 있고, 구형 브라우저 지원을 위한 도구(Webpack)을 이용해 보았습니다.',
  },
  {
    name: 'STYLED-COMPONENTS',
    icon: './images/skill/styled-components-logo.png',
    level: 70,
    text: 'Styled-components를 통해 스타일 모듈화를 구현하며 CSS-in-JS 기법을 사용해보았습니다.',
  },
  {
    name: 'JAVASCRIPT',
    icon: './images/skill/js-logo.png',
    level: 80,
    text: '비동기 프로세스와 실행 컨텍스트, this 바인딩 등 JS의 코어 개념들을 잘 이해하고 있으며 활용할 수 있습니다.',
  },
  {
    name: 'JQUERY',
    icon: './images/skill/jquery-logo.png',
    level: 70,
    text: '실무에서 활용해본 경험이 있으며 효율적인 DOM조작법을 알고 있습니다.',
  },
  {
    name: 'REACT',
    icon: './images/skill/react-logo.png',
    level: 80,
    text: '재사용성을 위한 컴포넌트 단위의 개발에 능숙하며 Virtual DOM, 컴포넌트 렌더링 조건에 대해 이해하고 있습니다.',
  },
  {
    name: 'REACT-QUERY (Tanstack Query)',
    icon: './images/skill/react-query-logo.png',
    level: 70,
  ...
  {
    name: 'TYPESCRIPT',
    icon: './images/skill/ts-logo.png',
    level: 60,
    text: 'JS를 정적 타입으로 개발하여 컴파일 단계에서의 오류를 잡고 서비스의 안정성을 향상시켰습니다.',
  },
  {
    name: 'STORYBOOK',
    icon: './images/skill/storybook-logo.png',
    level: 50,
...
export const versionControlSkillArray = [
  {
    name: 'GIT',
    icon: './images/skill/git-logo.png',
    level: 70,
    text: 'Git을 이용해 팀원들과 다양한 협업 및 버전 관리를 진행했습니다. branch 관리 및 rebase를 통해 프로젝트를 유연하게 유지시켰고 submodule을 이용해보았습니다.',
  },
  {
    name: 'GITHUB',
    icon: './images/skill/github-logo.svg',
    level: 80,
    text: 'GitHub를 이용해 개인 프로젝트의 버전관리를 진행하였습니다.',
  },
  {
    name: 'BITBUCKET',
    icon: './images/skill/bitbucket-logo.jpeg',
    level: 80,
...
export const communicationArray = [
  {
    name: 'JIRA',
    icon: './images/skill/jira-logo.jpeg',
    level: 80,
    text: 'Jira를 통해 이슈 관리를 상시적으로 진행하였고 이슈 트래킹에 익숙합니다. 또한 팀프로젝트에서 커뮤니케이션을 위해 Kanban 보드를 이용해보았고 스프린트 작업 방식에 익숙하여 Scrum meeting을 진행하며 작업 해보았습니다. 타부서의 요청사항(=이슈)들을 jira를 통해 팀원들과 공유하여 장애 해결 및 유지/보수 하였습니다.',
  },
  {
    name: 'ZEPLIN',
    icon: './images/skill/zeplin-logo.jpeg',
    level: 50,
    text: 'Zeplin 툴을 통해 작업하며 디자이너들과 소통하여 UI작업의 효율성을 높였던 경험이 있습니다. ',
  },
  {
    name: 'FIGMA',
    icon: './images/skill/figma-logo.png',
    level: 70,
...
export const etcSkillArray = [
  {
    name: 'PHP',
    icon: './images/skill/php-logo.png',
    level: 50,
